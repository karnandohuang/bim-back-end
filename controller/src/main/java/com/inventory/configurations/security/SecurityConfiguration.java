...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/assignments").hasAnyRole(EMPLOYEE, SUPERIOR)
                .antMatchers(HttpMethod.GET, "/api/assignments/employee").hasAnyRole(EMPLOYEE, SUPERIOR)
                .antMatchers(HttpMethod.GET, "/api/assignments/superior/employee").hasRole(SUPERIOR)
                .antMatchers(HttpMethod.PUT, "/api/assignments/changeStatus").hasAnyRole(ADMIN, SUPERIOR)
                .antMatchers(HttpMethod.PUT, "/api/assignments/**").hasRole(ADMIN)
