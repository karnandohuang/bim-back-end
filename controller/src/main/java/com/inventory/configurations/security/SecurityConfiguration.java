...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/assignments/value").hasAnyRole(EMPLOYEE, SUPERIOR)
                .antMatchers(HttpMethod.GET, "/api/assignments/superior/value").hasRole(SUPERIOR)
